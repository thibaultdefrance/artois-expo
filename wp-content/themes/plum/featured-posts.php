<?php if ( get_theme_mod('plum_a_box_enable') && is_front_page() ) : ?>
<div class="container-fluid fpfull-container">
		<div class="section-title title-font">
			<?php echo esc_html( get_theme_mod('plum_a_box_title',__('Trending','plum')) ) ?>
		</div>
	    ...
	    <div class="featured-grid-container">
	        <div class="fg-wrapper">
	            <?php
			        	...
			        	'post_type' => 'post',
			        	'posts_per_page' => 4, 
			        	'cat'  => esc_html( get_theme_mod('plum_a_box_cat',0) ),
