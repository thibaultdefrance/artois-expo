<?php if ( get_theme_mod('plum_a_box2_enable') && is_front_page() ) : ?>
<div class="container fposts2">
		<div class="section-title title-font">
			<?php echo esc_html( get_theme_mod('plum_a_box2_title',__('Trending','plum')) ) ?>
		</div>
	    ...
	    <div class="featured-grid-container">
	        <div class="fg-wrapper">
	            <?php
			        	...
			        	'post_type' => 'post',
			        	'posts_per_page' => 3, 
			        	'cat'  => esc_html( get_theme_mod('plum_a_box2_cat',0) ),
